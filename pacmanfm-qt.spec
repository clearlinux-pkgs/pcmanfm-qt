...
Version  : 0.14.0
Release  : 1
URL      : https://downloads.lxqt.org/downloads/pcmanfm-qt/0.14.0/pcmanfm-qt-0.14.0.tar.xz
Source0  : https://downloads.lxqt.org/downloads/pcmanfm-qt/0.14.0/pcmanfm-qt-0.14.0.tar.xz
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-2.0
Requires: pacmanfm-qt-bin = %{version}-%{release}
Requires: pacmanfm-qt-data = %{version}-%{release}
Requires: pacmanfm-qt-license = %{version}-%{release}
Requires: pacmanfm-qt-man = %{version}-%{release}
...
%package bin
Summary: bin components for the pacmanfm-qt package.
Group: Binaries
Requires: pacmanfm-qt-data = %{version}-%{release}
Requires: pacmanfm-qt-license = %{version}-%{release}
Requires: pacmanfm-qt-man = %{version}-%{release}
...
%description bin
bin components for the pacmanfm-qt package.


%package data
Summary: data components for the pacmanfm-qt package.
Group: Data

%description data
data components for the pacmanfm-qt package.


%package license
Summary: license components for the pacmanfm-qt package.
Group: Default

%description license
license components for the pacmanfm-qt package.


%package man
Summary: man components for the pacmanfm-qt package.
Group: Default

%description man
man components for the pacmanfm-qt package.


%prep
%setup -q -n pcmanfm-qt-0.14.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1549562350
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
export SOURCE_DATE_EPOCH=1549562350
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/pacmanfm-qt
cp LICENSE %{buildroot}/usr/share/package-licenses/pacmanfm-qt/LICENSE
pushd clr-build
%make_install
popd
...
/usr/share/package-licenses/pacmanfm-qt/LICENSE
